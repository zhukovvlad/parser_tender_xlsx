...
4. **RAG-сопоставление** - автоматически сопоставляет позиции с нормативными каталогами строительных работ для стандартизации данных
...
- **Google Gemini 1.5 Pro** - продвинутая LLM для анализа и классификации строительных позиций
- **RAG-поиск** - сопоставление с нормативными каталогами через Google File Search API
- **Автоматическая категоризация** - определение типов работ (13+ категорий: нулевой цикл, фасады, кровля, сети и т.д.)
- **Извлечение технических параметров** - автоматическое выделение объёмов, материалов, характеристик из текстовых описаний
...
GOOGLE_RAG_MODEL=gemini-1.5-pro-latest  # опционально, модель для RAG
...
- Бескорпусный RAG: загрузка файла → поиск через модель
