...
def simple_test():
    ...
    positions_file = "/root/Projects/Python_projects/parser/pending_sync_positions/temp_1754203333_5037_594277_positions.md"
    ...
    try:
        ...
        result = process_tender_positions.apply(
            args=["test_tender", "test_lot", positions_file, api_key]
        )
