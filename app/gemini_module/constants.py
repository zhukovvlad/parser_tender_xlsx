...
TENDER_CONFIGS = {
    "Нулевой цикл": {
        ...
        "json_structure": """
        {
          ...
          "slurry_wall_specs": {
            "is_slurry_wall": "Есть ли устройство стены в грунте в документе (true/false)" <bool>,
          ...
          "sheet_pile_wall_specs": {
            "is_sheet_pile": "Есть ли шпунтовое ограждение котлована (true/false)" <bool>,
            "length_m": ["Протяжённость шпунтового ограждения в погонных метрах (м.п.)"] [<список чисел> | null],
            "diameter_mm": "Диаметр шпунта в миллиметрах, если указан (например, 530 из "Труба ограждения 530х8 мм")" <число | null>,
