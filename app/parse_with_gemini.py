...
def parse_file_with_gemini(xlsx_path: str, 
                          async_processing: bool = False,
                          redis_config: Optional[Dict] = None) -> bool:
    """
...
def process_tender_with_gemini(tender_json_path: Path,
                              async_processing: bool = False,
                              redis_config: Optional[Dict] = None) -> bool:
    """
...
def get_processing_status(tender_id: str, lot_ids: List[str], 
                         redis_config: Optional[Dict] = None) -> Dict:
    """
